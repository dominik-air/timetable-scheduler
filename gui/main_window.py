...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_cooling_schedule.setGeometry(QtCore.QRect(20, 380, 101, 16))
        ...
        self.horizontalSlider_alpha.setProperty("value", 99)
        ...
        self.horizontalSlider_lecturer_availability_2 = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider_lecturer_availability_2.setGeometry(QtCore.QRect(530, 220, 191, 61))
        self.horizontalSlider_lecturer_availability_2.setAcceptDrops(False)
        self.horizontalSlider_lecturer_availability_2.setAutoFillBackground(False)
        self.horizontalSlider_lecturer_availability_2.setProperty("value", 50)
        self.horizontalSlider_lecturer_availability_2.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_lecturer_availability_2.setInvertedAppearance(False)
        self.horizontalSlider_lecturer_availability_2.setInvertedControls(False)
        self.horizontalSlider_lecturer_availability_2.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.horizontalSlider_lecturer_availability_2.setTickInterval(0)
        self.horizontalSlider_lecturer_availability_2.setObjectName("horizontalSlider_lecturer_availability_2")
        self.label_test = QtWidgets.QLabel(self.centralwidget)
        self.label_test.setGeometry(QtCore.QRect(590, 170, 81, 61))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_test.setText(_translate("MainWindow", "TextLabel"))
