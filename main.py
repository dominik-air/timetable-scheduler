...
if __name__ == '__main__':
    timetable_scheduler.create_dataset(term_id=1, lecturer_p=1, room_p=1)
    ...
    timetable_scheduler.export_availability_to_excel(export_type='room', id='SWFIS-1', filename='room_availability')
