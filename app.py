...
class MainWindow(QMainWindow, main_window.Ui_MainWindow):
    ...
    def change_parameters(self, index):
        ...
        if index == 0:
            ...
            self.doubleSpinBox_tmin.setValue(0.166)
            self.spinBox_kmax.setValue(30)
            self.horizontalSlider_alpha.setMinimum(9000)
            self.horizontalSlider_alpha.setMaximum(9999)
            self.horizontalSlider_alpha.setProperty("value", 9950)
            self.horizontalSlider_alpha.setTickInterval(100)
        elif index == 2:
            self.doubleSpinBox_tmax.setValue(15)
            self.doubleSpinBox_tmin.setValue(0.15)
            self.spinBox_kmax.setValue(100)
            self.horizontalSlider_alpha.setMinimum(1)
            self.horizontalSlider_alpha.setMaximum(1000)
            self.horizontalSlider_alpha.setProperty("value", 100)
            self.horizontalSlider_alpha.setTickInterval(100)
        elif index == 3:
            self.doubleSpinBox_tmax.setValue(30)
            self.doubleSpinBox_tmin.setValue(0.434)
            self.spinBox_kmax.setValue(10)
            self.horizontalSlider_alpha.setMinimum(10000)
            self.horizontalSlider_alpha.setMaximum(200000)
            self.horizontalSlider_alpha.setProperty("value", 100000)
            self.horizontalSlider_alpha.setTickInterval(10000)
        elif index == 4:
            self.doubleSpinBox_tmax.setValue(1000)
            self.doubleSpinBox_tmin.setValue(0.004)
            self.spinBox_kmax.setValue(1)
            self.horizontalSlider_alpha.setMinimum(1)
            self.horizontalSlider_alpha.setMaximum(10000)
            self.horizontalSlider_alpha.setProperty("value", 2200)
            self.horizontalSlider_alpha.setTickInterval(1000)
        elif index == 5:
            self.horizontalSlider_alpha.setEnabled(False)
            self.doubleSpinBox_tmax.setValue(50)
            self.doubleSpinBox_tmin.setValue(6.32)
            self.spinBox_kmax.setValue(20)
            self.horizontalSlider_alpha.setMinimum(9000)
            self.horizontalSlider_alpha.setMaximum(10000)
            self.horizontalSlider_alpha.setProperty("value", 10000)
            self.horizontalSlider_alpha.setTickInterval(100)
        elif index == 6:
            self.horizontalSlider_alpha.setEnabled(False)
            self.doubleSpinBox_tmax.setValue(50)
            self.doubleSpinBox_tmin.setValue(0.05)
            self.spinBox_kmax.setValue(40)
            self.horizontalSlider_alpha.setMinimum(9000)
            self.horizontalSlider_alpha.setMaximum(10000)
            self.horizontalSlider_alpha.setProperty("value", 10000)
            self.horizontalSlider_alpha.setTickInterval(100)
